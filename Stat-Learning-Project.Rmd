...
The scaling function worked.  We have decided not use scaled data for our models below.  If we change our approach, we just have to uncomment the code below:
```{r}
######################################################
...
##COMPARISON
Plot a comparison of the base and optimized model
```{r}
